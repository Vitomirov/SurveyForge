...
export function HeaderLogoutButton({ onLogout, className = '' }) {
  ...
  return (
    <button
      ...
      className={`inline-flex items-center justify-center gap-2 text-sm font-medium text-ink-600 hover:text-rose-600 hover:bg-rose-50 px-2.5 sm:px-3 py-2 rounded-lg transition-colors shrink-0 focus-ring ${className}`}
    >
