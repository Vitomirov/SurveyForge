/** Canonical survey defaults — single source for builder, taker, and initial state. */

export const DEFAULT_SURVEY_TITLE = 'Untitled Survey'
export const DEFAULT_START_BUTTON_TEXT = 'Start Survey'
