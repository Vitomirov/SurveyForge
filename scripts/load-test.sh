...
#
# Usage:
#   ./scripts/load-test.sh           # full ramp (default peak 200 VUs, ~8 min)
#   ./scripts/load-test.sh --quick   # short smoke (~1 min, 20 VUs)
#   ./scripts/load-test.sh --down    # stop the load-test stack and exit
#   MAX_VUS=100 ./scripts/load-test.sh
#
